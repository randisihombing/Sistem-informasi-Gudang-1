                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $data_brg->jenis_barang ?></td>
                ...
                <form role="form" id="frmUbh">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-select">
                            <select class="col-xs-12 col-md-12" type="text" id="jenis_barang" name="jenis_barang">
                                <option value="">- Pilih Jenis Barang -</option>
                                <?php
                                $jenis = $this->db->query("select * from jenis")->result();
                                foreach ($jenis as $data_jen) {
                                ?>
                                    <option value="<?php echo $data_jen->jenis_barang ?>"><?php echo $data_jen->jenis_barang ?></option>
                                <?php
                                }
                                ?>
                            </select>
