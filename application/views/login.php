...
<head>
    ...
    <meta charset="utf-8" />
    <title>CV.Karya Elang Mas</title>

    <meta name="description" content="User login page" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
    <link rel="stylesheet" href="<?= base_url('assetss/') ?>assets/css/style.css" />
    <link rel="icon" type="image/png" href="<?= base_url('assetss/') ?>assets/images/favicon.ico" />
                    ...
                    <div class="login-container">
                        <div class="center">
                            <h1>
                                ...
                                <span class="red">CV.Karya Elang Mas</span>
                                <span class="white" id="id-text2">Rawtype Riot</span>
                            </h1>
                        </div>
