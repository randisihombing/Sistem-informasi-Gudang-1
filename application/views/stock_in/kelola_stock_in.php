                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center" width="160px">
                                            <button class="btn btn-warning btn-xs" id="detail1" data-toggle="modal" data-target="#modal-detail" data-id="<?= $data_brg->kode_nama ?>" data-barangnama="<?= $data_brg->barang_nama ?>" data-qty="<?= $data_brg->qty ?>" data-date="<?= $data_brg->created_date ?>" data-keterangan="<?= $data_brg->keterangan ?>" title="Lihat">
                                                <i class="fa fa-eye"></i>
                                            </button>
