                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <form role="form" id="frmtbh">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="-" id="jenis_barang" name="jenis_barang" readonly>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-8">
                    ...
                    <tbody>
                        ...
                        foreach ($barang as $b => $data) { ?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <button class="btn btn-xs btn-info" id="select" data-id="<?= $data->barang_id ?>" data-kode_barang="<?= $data->kode_barang ?>" data-jenis_barang="<?= $data->jenis_barang ?>" data-nama=" <?= $data->nama ?>" data-stock="<?= $data->stock ?>">
...
<script type="text/javascript">
    $(document).on('click', '#select', function() {
        ...
        $('#jenis_barang').val($(this).data('jenis_barang'))
